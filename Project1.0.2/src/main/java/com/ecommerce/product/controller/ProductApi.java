...
public interface ProductApi {
     ...
     */
    @ApiOperation(value = "get the list of specific category of products", nickname = "getAllCategoryProducts", notes = "It gets all the products from the specific category", response = ProductResponse.class, tags={ "UserProduct","SellerProduct", })
    @ApiResponses(value = { 
     ...
     * @return okay accepted (status code 200)
     */
    @ApiOperation(value = "get a single product from the database by its name", nickname = "getSingleProductBySeller", notes = "returns a single product by matching name", response = Product.class, tags={ "SellerProduct", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "okay accepted", response = Product.class) })
    @RequestMapping(value = "/product/{sellerID}/{ProductName}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<Product> getSingleProductBySeller(@ApiParam(value = "",required=true) @PathVariable("ProductName") String productName,@ApiParam(value = "",required=true) @PathVariable("sellerID") String sellerID) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
     ...
     * @return okay accepted (status code 200)
     */
    @ApiOperation(value = "get a single product from the database by its name", nickname = "getSingleProducts", notes = "returns a single product by matching name", response = Product.class, tags={ "UserProduct","OrderProduct", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "okay accepted", response = Product.class) })
    @RequestMapping(value = "/product/productView/{ProductName}",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    default ResponseEntity<Product> getSingleProducts(@ApiParam(value = "",required=true) @PathVariable("ProductName") String productName) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"quantity\" : 10, \"sellerNumber\" : \"ae04a3db-8169-4f91-95f9-478bdb107840\", \"price\" : 12.25, \"name\" : \"shoes\", \"discount\" : 20, \"details\" : \"description of the image that we want to show\", \"category\" : \"hardware\" }";
     ...
     * @return okay accepted (status code 200)
     */
    @ApiOperation(value = "changethe details of single product from the database by its name", nickname = "updateSingleProducts", notes = "change  a single product by matching name", response = Product.class, tags={ "SellerProduct", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "okay accepted", response = Product.class) })
    @RequestMapping(value = "/product/{sellerID}/{ProductName}",
        produces = { "application/json" }, 
    ...
    default ResponseEntity<Product> updateSingleProducts(@ApiParam(value = "",required=true) @PathVariable("ProductName") String productName,@ApiParam(value = "",required=true) @PathVariable("sellerID") String sellerID,@ApiParam(value = "" ,required=true )  @Valid @RequestBody Product product) {
        getRequest().ifPresent(request -> {
            for (MediaType mediaType: MediaType.parseMediaTypes(request.getHeader("Accept"))) {
                if (mediaType.isCompatibleWith(MediaType.valueOf("application/json"))) {
                    String exampleString = "{ \"quantity\" : 10, \"sellerNumber\" : \"ae04a3db-8169-4f91-95f9-478bdb107840\", \"price\" : 12.25, \"name\" : \"shoes\", \"discount\" : 20, \"details\" : \"description of the image that we want to show\", \"category\" : \"hardware\" }";
