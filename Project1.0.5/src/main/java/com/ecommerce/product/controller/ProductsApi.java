...
public interface ProductsApi {
    ...
    default ResponseEntity<ProductResponse> getAllProducts(@ApiParam(value = "") @Valid @RequestParam(value = "name", required = false) String name,@ApiParam(value = "") @Valid @RequestParam(value = "price", required = false) Double price,@ApiParam(value = "") @Valid @RequestParam(value = "category", required = false) String category,@ApiParam(value = "") @Valid @RequestParam(value = "discount", required = false) Integer discount,@ApiParam(value = "", defaultValue = "0") @Valid @RequestParam(value = "offset", required = false, defaultValue="0") Integer offset,@ApiParam(value = "", defaultValue = "15") @Valid @RequestParam(value = "limit", required = false, defaultValue="15") Integer limit) {
